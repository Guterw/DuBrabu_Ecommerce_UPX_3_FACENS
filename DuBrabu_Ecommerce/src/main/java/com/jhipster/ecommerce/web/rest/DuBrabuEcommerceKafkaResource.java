...
@RestController
@RequestMapping("/api/du-brabu-ecommerce-kafka")
public class DuBrabuEcommerceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DuBrabuEcommerceKafkaResource.class);
    ...
    public DuBrabuEcommerceKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
